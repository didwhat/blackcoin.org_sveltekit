					...
					if (!i.TweenLite) {
						...
						var g = [0, 0, 1, 1],
							...
							P = (y.register = function (t, e, i, s) {
								for (
									...
									for (
										r = l[_], n = s ? v('easing.' + r, null, !0) : h.easing[r] || {}, a = u.length;
										--a > -1;
						...
						v('Ticker', function (t, e) {
							...
							b.call(h),
								...
								(h.sleep = function () {
									null != n &&
										(m && A ? A(n) : clearTimeout(n), (s = f), (n = null), h === a && (o = !1));
								}),
								(h.wake = function () {
								...
								(h.fps = function (t) {
									return arguments.length
										? ((i = t), (r = 1 / (i || 60)), (l = this.time + r), h.wake(), void 0)
										: i;
								}),
								(h.useRAF = function (t) {
						...
						var I = v(
								...
								function (e, i, s) {
									...
									if (
										((this._overwrite = l =
											null == l ? Q[I.defaultOverwrite] : 'number' == typeof l ? l >> 0 : Q[l]),
										(o || e instanceof Array || (e.push && m(e))) && 'number' != typeof e[0])
									)
										for (
											this._targets = a = u(e), this._propLookup = [], this._siblings = [], n = 0;
											a.length > n;
											n++
										)
											(r = a[n]),
					...
					_gsScope._gsDefine(
						...
						function (t) {
							...
							return (
								...
								(d.getRatio = function (t) {
									return (
										0 > t ? (t = 0) : t >= 1 && (t = 0.999999999), ((this._p2 * t) >> 0) * this._p1
									);
								}),
								(d.config = e.config =
									function (t) {
					...
					(function () {
						...
						function r() {
							if (y) {
								h.clearRect(0, 0, s, u);
								for (var e in v)
									Math.abs(m(g, v[e])) < 4e3
										? ((v[e].active = 0.3), (v[e].circle.active = 0.6))
										: Math.abs(m(g, v[e])) < 2e4
										? ((v[e].active = 0.1), (v[e].circle.active = 0.3))
										: Math.abs(m(g, v[e])) < 4e4
										? ((v[e].active = 0.02), (v[e].circle.active = 0.1))
										: ((v[e].active = 0), (v[e].circle.active = 0)),
										l(v[e]),
										v[e].circle.draw();
							}
						...
						function l(e) {
							if (e.active)
								for (var n in e.closest)
									h.beginPath(),
										h.moveTo(e.x, e.y),
										h.lineTo(e.closest[n].x, e.closest[n].y),
										(h.strokeStyle = 'rgba(235,235,235,' + e.active + ')'),
										h.stroke();
						}
							...
							!(function () {
								...
								(this.draw = function () {
									i.active &&
										...
										(h.fillStyle = 'rgba(255,255,255,' + i.active + ')'),
										h.fill());
								});
						}
